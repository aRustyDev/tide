...
- [src/tide.langium](src/tide.langium) -  The grammar definition of your language
- [src/tide-module.ts](src/tide-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/tide-validator.ts](src/tide-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/tide.monarch.ts](src/syntaxes/tide.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/tide.tmLanguage.json](syntaxes/tide.tmLanguage.json) - Textmate based syntax highlighting instructions.
